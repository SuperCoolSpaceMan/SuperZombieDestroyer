...
@onready var weapon_1_hr = preload("res://WEAPON_HR's/Pistol.tscn")
@onready var weapon_1 = preload("res://WEAPON_PICKUPS/WEAPON 1.tscn")

@onready var weapon_2_hr = preload("res://WEAPON_HR's/AssaultGun.tscn")
@onready var weapon_2 = preload("res://WEAPON_PICKUPS/WEAPON 2.tscn")
 
@onready var weapon_3_hr = preload("res://WEAPON_HR's/Shotgun.tscn")
